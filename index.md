...
venue: "Facultad de Ciencias Naturales y Exactas de la Universidad de Panamá"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: " Panamá, Provincia de Panamá, Panamá"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "Panama"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
...
humandate: "26 Mayo- 11 Julio 2025 "    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "4:00 pm - 7:00pm GMT-5"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: "2025-05-26"      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: "2025-07-11"        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Katia Aviña Padilla", "Maribel Hernandez", "Shaday Guerrero Flores", "Obed Ramírez Sánchez"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["helper one", "helper two"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["katia.avinap@cinvestav.mx","maribel.hr@cinvestav.mx", "shaday.guerrero@cinvestav.mx"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
